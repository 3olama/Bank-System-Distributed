...
public class SignupOne extends JFrame implements ActionListener{
    ...
    {    
        try 
        {
            ...
            String mariatal = "";
            if(married.isSelected()) mariatal = "Married";
            else if (unmarried.isSelected()) mariatal = "Unmarried";
            if(mariatal.equals("")) {
            ...
            String ssn = service.signupStepOne(
                name, dob, gender, email, mariatal,
                address, city, state, zip
            );

            if(ssn != null){
            	//JOptionPane.showMessageDialog(this, "Step 1 Completed \nYour SSN is: " + ssn);
                dispose();
                ...
                JOptionPane.showMessageDialog(this, "Error Step 1");
            }
