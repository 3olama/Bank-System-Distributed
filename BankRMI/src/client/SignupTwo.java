...
public class SignupTwo extends JFrame implements ActionListener {
    ...
    public void actionPerformed(ActionEvent ae) {
        try {
            ...
            boolean success = service.signupStepTwo(ssn,passportNo, race, category, income, education, occupation, seniorCitizen, existAcnt);

            if(success) {
                JOptionPane.showMessageDialog(this, "Step 2 Completed.");
